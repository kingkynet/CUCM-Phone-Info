    ...
    for item in results:
      ...
      if item.phonescrape == None:
        ...
        phone_schema_obj = schemas.PhoneScraper(
          ...
          dns3 = item.phonescrape.dns3,
          dns4 = item.phonescrape.dns4,
          dns5 = item.phonescrape.dns5,
...
def get_phone_all_schema(*, token: str = Security(is_auth)):
    ...
    for item in results:
      ...
      if item.phonescrape != None:
        ...
        phone_cucm_scraper_combined_schema_obj.dns3 = item.phonescrape.dns3
        phone_cucm_scraper_combined_schema_obj.dns4 = item.phonescrape.dns4
        phone_cucm_scraper_combined_schema_obj.dns5 = item.phonescrape.dns5
