...
def parse_standard_models(model: str, config_text: str, device_text: str, status_text: str, network_text: str) -> PhoneScraper:
    ...
    if config_text != None:
        ...
        phone_scrape_data = regex_search_and_assign_if_match('dns3', '(DNS Server 3_\n_\n_|DNS server 3_|DNS Server 3_)([^(_| )]*)', config_text, phone_scrape_data)       
        phone_scrape_data = regex_search_and_assign_if_match('dns4', '(DNS Server 4_\n_\n_|DNS server 4_|DNS Server 4_)([^(_| )]*)', config_text, phone_scrape_data)       
        phone_scrape_data = regex_search_and_assign_if_match('dns5', '(DNS Server 5_\n_\n_|DNS server 5_|DNS Server 5_)([^(_| )]*)', config_text, phone_scrape_data)       
...
def parse_7937_model(device_text: str, network_text:str) -> PhoneScraper:
    ...
    if network_text != None:
        ...
        phone_scrape_data = regex_search_and_assign_if_match('dns3', '(DNS Server 3 : *)([^(_| )]*)', network_text, phone_scrape_data)
        phone_scrape_data = regex_search_and_assign_if_match('dns4', '(DNS Server 4 : *)([^(_| )]*)', network_text, phone_scrape_data)
        phone_scrape_data = regex_search_and_assign_if_match('dns5', '(DNS Server 5 : *)([^(_| )]*)', network_text, phone_scrape_data)
